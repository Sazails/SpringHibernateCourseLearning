...
<form:form action="processForm" modelAttribute="user">
    ...
    Current Emotion
    <br>
    <form:checkbox path="emotionOptions" value="Neutral"/>
    <br>
    <form:checkbox path="emotionOptions" value="Happy"/>
    <br>
    <form:checkbox path="emotionOptions" value="Sad"/>
    <br>
    <form:checkbox path="emotionOptions" value="Angry"/>
    <br>
