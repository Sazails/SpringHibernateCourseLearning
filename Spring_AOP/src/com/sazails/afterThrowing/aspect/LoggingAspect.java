package com.sazails.afterThrowing.aspect;
...
public class LoggingAspect {
    ...
    @AfterThrowing(pointcut = "execution(* com.sazails.afterThrowing.dao.AccountDAO.findAccounts(..))", throwing = "ex")
    ...
    @AfterReturning(pointcut = "execution(* com.sazails.afterThrowing.dao.AccountDAO.findAccounts(..))", returning = "result")
